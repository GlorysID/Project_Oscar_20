<?php
    ...
    if (!$email) { header('Location: forgotpassword.php'); exit; }
...
?>
    ...
    <html lang="en">
      <head>
        ...
        <title>Kiddos Reset Password</title>
        <link
      ...
      <body>
          ...
          <section class="banner">
            ...
            <div class="wrapper">
              <div class="glass-container">
                ...
                <form class="login-form" method="POST" action="updatepassword.php">
                  <!-- Hidden input buat email -->
                  ...
                  <div class="form-group">
                    ...
                    <small class="error-msg" id="newPassError">Password must be at least 6 characters</small>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <small class="error-msg" id="confirmPassError">Passwords do not match</small>
                  </div>
        ...
        <script>
          ...
          setupToggle("confirmPassword", "toggleConfirmPass");
